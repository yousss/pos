<div class="grid-container">
    ...
    <?php echo $__env->make('ui::datagrid.filters', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    
    <?php echo $__env->make('ui::datagrid.table', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    
    <?php $__env->startPush('scripts'); ?>
        <script type="text/javascript">
            var columns = <?php echo json_encode($columns, 15, 512) ?>; //referential
            var allFilters = [];
            var search_value;
            var filter_column;
            ...
            $(document).ready(function() {
                var actions = [];
                <?php if(isset($massoperations) && count($massoperations)): ?>
                    const massactions = <?php echo json_encode($massoperations, 15, 512) ?>;
