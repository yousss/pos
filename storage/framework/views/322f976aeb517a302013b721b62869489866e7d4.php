<form data-vv-scope="address-form">
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <?php if(auth()->guard('customer')->guest()): ?>
                <a href="<?php echo e(route('customer.session.index')); ?>" class="btn btn-lg btn-primary">
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[email]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control" id="billing[email]" name="billing[email]" v-model="address.billing.email" data-vv-as="&quot;<?php echo e(__('shop::app.checkout.onepage.email')); ?>&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[address1]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control" id="billing[address1]" name="billing[address1]" v-model="address.billing.address1" data-vv-as="&quot;<?php echo e(__('shop::app.checkout.onepage.address1')); ?>&quot;"/>
        ...
        <div class="control-group">
            <label for="billing[address2]">
                <?php echo e(__('shop::app.checkout.onepage.address2')); ?>
    ...
    <div class="form-container" v-if="!address.billing.use_for_shipping">
        ...
        <div class="control-group" :class="[errors.has('address-form.shipping[email]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control" id="shipping[email]" name="shipping[email]" v-model="address.shipping.email" data-vv-as="&quot;<?php echo e(__('shop::app.checkout.onepage.email')); ?>&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.shipping[address1]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control" id="shipping[address1]" name="shipping[address1]" v-model="address.shipping.address1" data-vv-as="&quot;<?php echo e(__('shop::app.checkout.onepage.address1')); ?>&quot;"/>
