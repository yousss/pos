        ...
        <form method="POST" action="<?php echo e(route('admin.sliders.update', $slider->id)); ?>" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                <div class="page-title">
                    <h1><?php echo e(__('admin::app.settings.sliders.edit-title')); ?></h1>
                </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="title" v-validate="'required'" data-vv-as="&quot;<?php echo e(__('admin::app.settings.sliders.title')); ?>&quot;" value="<?php echo e($slider->title ?: old('title')); ?>">
                    ...
                    <div class="control-group">
                        <image-wrapper :button-label="'<?php echo e(__('admin::app.settings.sliders.image')); ?>'" input-name="image" :multiple="false" :images='"<?php echo e(url('storage/'.$slider->path)); ?>"'></image-wrapper>
                    </div>
