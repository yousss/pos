        ...
        <form method="POST" action="<?php echo e(route('admin.sales.shipments.store', $order->id)); ?>" @submit.prevent="onSubmit">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h1><?php echo e(__('admin::app.sales.shipments.add-title')); ?></h1>
                </div>
                                        ...
                                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item->qty_to_ship > 0): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="control-group" :class="[errors.has('shipment[items][<?php echo e($item->id); ?>]') ? 'has-error' : '']">
                                                            <input type="text" v-validate="'required|numeric|min:0'" class="control" id="shipment[items][<?php echo e($item->id); ?>]" name="shipment[items][<?php echo e($item->id); ?>]" value="<?php echo e($item->qty_to_ship); ?>" data-vv-as="&quot;<?php echo e(__('admin::app.sales.shipments.qty-to-ship')); ?>&quot;"/>

                                                            <span class="control-error" v-if="errors.has('shipment[items][<?php echo e($item->id); ?>]')">
